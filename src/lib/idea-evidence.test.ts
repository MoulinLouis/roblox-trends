  ...
  return {
    ...
    analysis: {
      ...
      metrics: {
        ...
        newDownVotes24h: 50,
        approvalRate: 90,
        likesPerThousandVisits24h: 1,
        favoritesPerThousandVisits24h: 10,
        rankMovement24h: qualifyingEvidence.rankMovement24h,
        enteredMainChart24h: false,
        chartBreadth: 1,
        ageDays: qualifyingEvidence.ageDays,
        persistence: qualifyingEvidence.persistence,
        historyHours: qualifyingEvidence.historyHours,
        durableGrowth: qualifyingEvidence.growth24h,
        durableGain: qualifyingEvidence.gain24h,
        durableWindowHours: 24,
        durabilityConfidence: 30,
        peakDrawdown72h: 0,
        eventRisk: false,
        sponsoredDiscoveryRisk: false,
